...
export interface ApiNewCollectionNewCollection extends Schema.CollectionType {
  collectionName: 'new_collections';
  info: {
    singularName: 'new-collection';
    pluralName: 'new-collections';
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<
      'api::new-collection.new-collection',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::new-collection.new-collection': ApiNewCollectionNewCollection;
